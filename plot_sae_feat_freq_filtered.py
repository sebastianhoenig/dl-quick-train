...
def plot_entity_token_analysis(entity_results: Dict, save_path: str = "entity_sae_analysis_filtered.png", use_less_sparse: bool = False):
...
def main():
    """Main function"""
    parser = argparse.ArgumentParser(description='Advanced Entity SAE Feature Analysis (Discriminative Features)')
    ...
    plot_entity_token_analysis(entity_results, f"entity_sae_analysis_filtered{suffix}.png", use_less_sparse=args.less_sparse)
